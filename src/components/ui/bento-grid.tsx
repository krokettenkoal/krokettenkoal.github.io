...
interface BentoCardProps extends ComponentPropsWithoutRef<"div"> {
    ...
    cta: string
    IconCta?: ElementType
    childrenWrapperProps?: ComponentPropsWithoutRef<"div">
    tags?: string[]
}
    ...
    >
        ...
        >
            ...
            >
                <a href={href}>
                    {cta}
                    <IconCta className="ms-2 h-4 w-4 rtl:rotate-180"/>
                </a>
            </Button>
        </div>

        <div
            className="pointer-events-none absolute inset-0 transform-gpu transition-all duration-300 group-hover:bg-black/3 group-hover:dark:bg-neutral-800/10"/>
    </div>
)
